package com.catsoft.esp32camera.ov2640;
...
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AEC;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AEC2;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AE_LEVEL;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AGC;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AGC_GAIN;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AWB;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.AWB_GAIN;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.BPC;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.BRIGHTNESS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.CAMERA_SETTINGS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.CAMERA_STATUS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.COLOR_BAR;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.COMMAND_STATUS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.CONTRAST;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.DCW;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.EFFECT;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.FACE_DETECTION;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.FACE_RECOGNITION;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.FRAMESIZE;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.GAIN_CEILING;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.HTTP;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.H_MIRROR;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.LENS_CORRECTION;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.QUALITY;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.RAW_GMA;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.REQUEST_SETTINGS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.SATURATION;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.SETTING;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.SETTINGS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.SETTINGS_RECEIVED;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.SET_SETTING;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.STATUS;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.VALUE;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.V_FLIP;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.WBMODE;
import static com.catsoft.esp32camera.ov2640.OV2640Constants.WPC;
...
public class OV2640Settings  implements Parcelable {
    ...
    // Constructor
    public OV2640Settings(Context context, String ipAddress){
        this.mContext = context;
        this.mIpAddress = ipAddress;
        this.mCameraSettingsUrl = HTTP + mIpAddress + "/settings";
        this.mCameraControlUrl = HTTP + mIpAddress + "/control";
        mCameraOnline = false;
    ...
    private void setSettings(String settings) {
        Log.i(TAG, "Camera @" + mIpAddress + " setSettings(...)");
        try {
    ...
    private void getSettings()  {
        Log.i(TAG, "Camera @" + mIpAddress + " getSettings()");
        new Thread(new Runnable() {
            @Override
            public void run() {
            ...
            switch (intent.getAction()) {
                case SETTINGS_RECEIVED:
                    ...
                    if((settings!=null) && (!settings.isEmpty())) {
                        Log.i(TAG, "Camera @" + mIpAddress + ": VALID DATA RECEIVED");
                        setSettings( settings );
                    }
                    else {
                        Log.i(TAG, "Camera @" + mIpAddress + ": NO OR INVALID DATA RECEIVED");
                    }
                    break;
