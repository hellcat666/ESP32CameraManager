...
import static com.catsoft.esp32camera.ov2640.OV2640Constants.MJPEG;
 ...
 */
public class OV2640CameraAdapter extends ArrayAdapter<OV2640Camera> {
    ...
    public OV2640CameraAdapter(Context context, ArrayList<OV2640Camera> ov2640Cameras) {
...
//            intentFilter.addAction( DOCUMENT_READY );
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from( getContext() ).inflate( R.layout.item_ov2640_camera, parent, false );
        }
...
//                    break;
     ...
     *
     * @param srvUrl Set the url of the Camera, calling JavaScript function setServerUrl(...)
     */
